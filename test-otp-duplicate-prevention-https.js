// Test OTP Duplicate Prevention with HTTPS
...
async function testOTPDuplicatePrevention() {
    console.log('🧪 Testing OTP Duplicate Prevention (HTTPS)...\n');
    ...
    try {
        ...
        console.log('📧 Test 2: Immediate duplicate request (should be rate limited)...');
        ...
        // Test 3: Resend should bypass rate limiting
        console.log('📧 Test 3: Resend request (should bypass rate limit)...');
        ...
        if (allPassed) {
            console.log('\n✅ OTP duplicate prevention is working correctly!');
            console.log('   - Server-side rate limiting prevents multiple OTP emails');
            console.log('   - Resend functionality still works as expected');
            console.log('   - Different emails are processed independently');
        }
